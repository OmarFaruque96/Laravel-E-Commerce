	  ...
	  <div class="col-sm-6 col-xl-12 col-md-12">
	      ...
	      <div class="pd-l-25 pd-r-15 pd-b-25">
	        <div class="bd rounded table-responsive">
	        	<form action="{{ route('district.store') }}" method="POST" enctype="multipart/form-data" class="p-5">
	        		...
	        		<div class="form-group">
	        			<input type="submit" class="btn btn-md btn-success" name="addDistrict" value="Add New District">
	        		</div>
