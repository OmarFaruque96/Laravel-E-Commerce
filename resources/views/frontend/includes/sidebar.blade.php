        ...
        <div class="side-menu animate-dropdown outer-bottom-xs">
          ...
          <nav class="yamm megamenu-horizontal">
            <ul class="nav">
              ...
              @foreach(App\Models\Backend\Category::orderBy('name','asc')->where('is_parent', 0)->get() as $menu)

              <li class="dropdown menu-item"> 
                <a href="" class="dropdown-toggle" data-toggle="dropdown">
                  <i class="icon {{$menu->icon_class}}" aria-hidden="true"></i>
                  {{ $menu->name }} 
                </a>
                      ...
                      <div class="row">
                          ...
                          <div class="col-sm-3 col-md-3">
                            <ul class="links list-unstyled">
                              @foreach(App\Models\Backend\Category::orderBy('name','asc')->where('is_parent', $menu->id)->get() as $submenu)

                                <li><a href="{{ route('category.show', $submenu->slug) }}">{{$submenu->name}}</a></li>
