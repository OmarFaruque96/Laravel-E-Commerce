    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 logo-holder"> 
          <!-- ============================================================= LOGO ============================================================= -->
          <div class="logo"> <a href="{{ route('homepage') }}"> <img src="{{asset('frontend/images/logo.png')}}" alt="logo"> </a> </div>
          <!-- /.logo --> 
          <!-- ============================================================= LOGO : END ============================================================= --> </div>
        <!-- /.logo-holder --> 
          ...
          <div class="dropdown dropdown-cart"> <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
            ...
            <ul class="dropdown-menu">
              <li>
                ...
                <div class="cart-item product-summary mb-2">
                  <div class="row">
                    <div class="col-xs-4">
                      <div class="image"> 
                        <a href="detail.html">
                    ...
                    <div class="col-xs-7">
                      <h3 class="name"><a href="index.php?page-detail">{{ $item->product->title }}</a></h3>
                      <div class="price">
                ...
                <div class="clearfix cart-total">
                  <div class="pull-right"> <span class="text">Sub Total :</span><span class='price'>${{ App\Models\Frontend\Cart::totalPrice() }}</span> </div>
                  <div class="clearfix"></div>
